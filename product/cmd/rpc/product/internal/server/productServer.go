...
func (s *ProductServer) ShowProductDetail(ctx context.Context, in *pb.ShowProductDetailReq) (*pb.ShowProductDetailResp, error) {
	l := logic.NewShowProductDetailLogic(ctx, s.svcCtx)
